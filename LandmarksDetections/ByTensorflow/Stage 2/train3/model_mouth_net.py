...
class MNet:
    ...
    def _buildGraph(self):
        ...
        # 执行卷积过程
        with tf.variable_scope('conv1_m'):
        ...
        with tf.variable_scope('conv2_m'):
        ...
        with tf.variable_scope('conv3_m'):
            # 高宽减半了。
        ...
        with tf.variable_scope('conv4_m'):
    ...
    def train(self, model_save, base_dir, display):
        ...
        :return:
        """
        file_path = os.path.join(base_dir, 'tfrecord/mouth.tfrecord_shuffle')
        # 读取tfrecord文件
        ...
        label_file = os.path.join(base_dir, 'mouth.txt')
    ...
    def read_single_tfrecord(self, tfrecord_file):
        ...
        image_features = tf.parse_single_example(serialized_example,
                                                 features={
                                                     ...
                                                     'image/label': tf.FixedLenFeature([10], tf.float32)
                                                 })
        ...
        label = tf.reshape(label, [ConfigN.BOX_BATCH_SIZE, 10])
        return image, label
