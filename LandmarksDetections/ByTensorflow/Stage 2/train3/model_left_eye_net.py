#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @Time : 2019/12/29 11:22
# @Author : Micky
# @Desc : 检测左眼的六个点
# @File : model_left_eye_net.py
# @Software: PyCharm
...
class LNet:
    ...
    def train(self, model_save, base_dir, display):
        ...
        :return:
        """
        file_path = os.path.join(base_dir, 'tfrecord/left_eye.tfrecord_shuffle')
        # 读取tfrecord文件
        ...
        label_file = os.path.join(base_dir, 'lefteyes.txt')
