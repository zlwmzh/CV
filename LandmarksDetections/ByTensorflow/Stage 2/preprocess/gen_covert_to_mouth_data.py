#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @Time : 2019/12/29 21:41
# @Author : Micky
# @Desc : 生成嘴部的tfrecord数据
# @File : gen_covert_to_mouth_data.py
# @Software: PyCharm
...
tf_filename = os.path.join(output_dir, 'mouth.tfrecord_shuffle')
