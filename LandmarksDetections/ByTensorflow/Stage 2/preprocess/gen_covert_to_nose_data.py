#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @Time : 2019/12/29 21:35
# @Author : Micky
# @Desc : 生成鼻子的tfrecord数据
# @File : gen_covert_to_nose_data.py
# @Software: PyCharm
...
tf_filename = os.path.join(output_dir, 'nose.tfrecord_shuffle')
